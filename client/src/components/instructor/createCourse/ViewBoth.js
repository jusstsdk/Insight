...
export default function ViewBoth(props) {
  ...
  const handleDeleteExercise = (exercise_key) => {
    ...
    let numberOfQuestions =
      props.SubtitleExercises[exercise_key].questions.length;
  ...
  const handleAddContentModalShow = (subtitle, subtitle_key) => {
    props.setSubtitle(subtitle);
    props.setSubtitlekey(subtitle_key);
  ...
  const handleDeleteVideo = async (video_key) => {
    let oldTotalSeconds = await getVideoDuration(
      props.SubtitleVideos[video_key].url,
    );
  ...
  return (
    <>
              ...
              >
                <div className="d-flex">
                  ...
                  <Col sm={1} className="d-flex justify-content-end">
                    ...
                    >
                      <BsTrash
                        key={"video_trash_" + getContentIndex(content)}
                      />
                    </Button>
                  </Col>
                </div>
      ...
      <Row className="mt-3 me-auto justify-content-end">
        ...
        <Button
          onClick={() =>
            handleAddContentModalShow(props.subtitle, props.subtitleKey)
          }
          className="me-3 w-auto"
        >
          Add Content
